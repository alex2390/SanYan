...
public class ConfigUtils {
    ...
    public static ShanYanUIConfig getCJSConfig(final Context context) {
        /************************************************自定义控件**************************************************************/
        int width = AbScreenUtils.getScreenWidth(context);
        int widthDp = AbScreenUtils.getScreenWidth(context, true);
        int heightDp = AbScreenUtils.getScreenWidth(context, true);
        ...
        Drawable logBtnImgPath = context.getResources().getDrawable(R.drawable.shape_main);
        Drawable uncheckedImgPath = context.getResources().getDrawable(R.drawable.umcsdk_uncheck_image);
        Drawable checkedImgPath = context.getResources().getDrawable(R.drawable.umcsdk_check_image);
        //其他方式登录
        TextView otherTV = new TextView(context);
        otherTV.setText("使用第三方账号登录");
        otherTV.setTextColor(0xff3a404c);
        otherTV.setTextSize(TypedValue.COMPLEX_UNIT_SP, 13);
        RelativeLayout.LayoutParams mLayoutParams1 = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
...
//                .setLogoOffsetX(20)
                ...
                //授权页号码栏：
                .setNumberColor(0xff000000)  //设置手机号码字体颜色
                .setNumFieldOffsetY(100)
                .setNumFieldOffsetX(100)
                .setNumFieldWidth(100)
                .setNumberSize(20)
                ...
                //授权页slogan：
                .setSloganTextColor(0xff999999)  //设置slogan文字颜色
                .setSloganOffsetY(150)  //设置slogan相对于标题栏下边缘y偏移
